...
namespace boost {
  ...
  namespace detail {
    ...
    template <typename ComponentMap, typename RootMap, typename DiscoverTime,
              typename Stack>
    class nuutila_scc_visitor : public dfs_visitor<> 
    {
      typedef typename property_traits<ComponentMap>::value_type comp_type;
      typedef typename property_traits<DiscoverTime>::value_type time_type;
    public:
      nuutila_scc_visitor(ComponentMap comp_map, RootMap r, DiscoverTime d, 
      ...
      void finish_vertex(typename graph_traits<Graph>::vertex_descriptor v,
                         const Graph& g) {
      	//Second traversal, store only nonroot elements on the stack
       ...
       const bgl_named_params<P, T, R>& params)
    {
      ...
      std::stack<Vertex> s;
      detail::nuutila_scc_visitor<ComponentMap, RootMap, DiscoverTime, 
        std::stack<Vertex> > 
